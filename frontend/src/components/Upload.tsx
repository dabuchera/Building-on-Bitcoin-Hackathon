...
const Upload = () => {
  ...
  const onDropRejected = useCallback(
    (fileRejections: FileRejection[]) => {
      const errorMessage =
        fileRejections.length > 1 ? 'You can only select 1 file' : fileRejections[0].file.size > MAX_FILE_SIZE ? 'File is too big' : 'Unknown error'
    ...
    <Box>
      ...
      <Flex flexDir="column">
        <FormControl isRequired>
          ...
          <Input onChange={handleFilenameChange} value={filename} border="2px" borderColor="black" _hover={{ borderColor: 'white' }} />
        </FormControl>
        ...
        <FormControl>
          ...
          <Switch id="isPublic" isChecked={isPublic} onChange={handlePublicChange} mt={4} mb={4}/>
        </FormControl>
