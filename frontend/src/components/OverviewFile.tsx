  ...
  return (
    ...
    >
      <HStack spacing={2} alignItems="center">
        ...
        {
          {
            public: <Badge variant='solid' colorScheme="green">Public</Badge>,
            private: <Badge variant='solid' colorScheme="red">Private</Badge>,
            shared: <Badge variant='solid' colorScheme="orange">Shared</Badge>,
          }[accessControl]
        }
        {useSTXAddress() === userAddress ? <Badge variant='solid' colorScheme="blue">Yours</Badge> : <></>}
