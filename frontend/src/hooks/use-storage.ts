...
const PRIVATE_METADATA_FILE_PATH = (process.env.PRIVATE_METADATA_FILE_PATH as string)
const PUBLIC_METADATA_FILE_PATH = (process.env.PUBLIC_METADATA_FILE_PATH as string)
    ...
    try {
      return await fetch(PUBLIC_METADATA_FILE_PATH)
        ...
        .then((data) => {
          ...
          console.log(process.env.DAPP_PRIVATE_KEY)
